...
describe("ConvertText", () => {
  ...
  //   const testString = "So, the other day, we went \"shopping\". Wasn't it great? I had fun! The virtues included: self-control, righteousness, and satisfaction; we need to grow in these.";
